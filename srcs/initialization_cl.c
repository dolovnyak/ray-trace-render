...
/*   Updated: 2019/07/03 21:03:15 by sbosmer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		get_files_buf(char **program_buf, size_t *program_size)
{
	...
	program_buf[8] = get_program_buf("srcs/cylinder.cl", &program_size[8]);
	program_buf[9] = get_program_buf("srcs/plane.cl", &program_size[9]);
	program_buf[10] = get_program_buf("srcs/cone.cl", &program_size[10]);
}
